...
var sumbitForm = function sumbitForm(ref) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post("/register", form, {
    headers: {
...
var handlefailedPayment = function handlefailedPayment(response) {
  notify({
    message: "You payment failed with the following reason: <em>".concat(response.message, "</em>, for any enquires please call <strong> 09028020900</strong>, you may submit your details now and retry payment at another time"),
    level: "danger",
    timeout: 3000
  });
};
...
var formIsInvalid = function formIsInvalid() {
  ...
  var fields = ["fullname", "phone", "email", "address", "assembly", "gender", "age"];
...
var assemblyInput = document.querySelector("#assemblyInput");
jquery__WEBPACK_IMPORTED_MODULE_1___default()("#assemblyInput").select2({
  theme: "bootstrap4",
